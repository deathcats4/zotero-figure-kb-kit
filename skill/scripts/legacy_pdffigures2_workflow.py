...
def build_kb_readme(profile: dict) -> str:
    ...
    lines = [
        ...
        "",
        "```powershell",
        "python .\\skill\\scripts\\legacy_pdffigures2_workflow.py <command> [options]",
        "```",
        "",
        "Examples:",
        "",
        "```powershell",
        "# 1. Initialize the KB",
        "python .\\skill\\scripts\\legacy_pdffigures2_workflow.py init",
        "",
        "# 2. Extract figures into a review batch",
        "python .\\skill\\scripts\\legacy_pdffigures2_workflow.py `",
        "  extract `",
